...
class RouteOptimizationEnv(gym.Env):
    ...
    def __init__(
        ...
        self.turn_amounts = np.array([-10.0, -5.0, 0.0, 5.0, 10.0], dtype=np.float32)
    ...
    def step(self, action):
        ...
        # ----------------------------------------------------
        # ACTION → HEADING RELATIVE TO DESIRED BEARING
        # ----------------------------------------------------
        ...
        # ============================================================
        # 1. REWARD PROGRESS TOWARD DESTINATION
        # ============================================================
        reward += progress * 8.0
        ...
        # ============================================================
        reward -= distance * 1.00

        # ============================================================
        # 3. TURNING PENALTY
        # Discourage unnecessary zig-zagging.
        # ============================================================
        reward -= abs(turn) * 0.015

        # ============================================================
        # 4. HEADING ERROR PENALTY
        # Encourage heading toward destination.
        # ============================================================
        reward -= heading_error * 0.003

        # ============================================================
        # 5. EXTRA PENALTY FOR MOVING AWAY
        # ============================================================
        if progress < 0:
            reward -= abs(progress) * 8.0
